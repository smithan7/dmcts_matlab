    ...
    methods
        ...
        function [obj, maxI] = ucb_m(obj)
            ...
            for i=1:length(obj.kids)
                ...
                obj.kids{i}.mean_reward = obj.kids{i}.cum_reward / max(0.01,obj.kids{i}.n_pulls);
            ...
            if isempty(obj.kids)
                ...
                if maxI > -1
                    ...
                    if maxI > 0
                        ...
                        obj.kids{maxI}.cum_reward = obj.kids{maxI}.cum_reward + (obj.kids{maxI}.down_branch_reward-minR) / max(0.001, maxR-minR);
                    end
                end
            end
        end
